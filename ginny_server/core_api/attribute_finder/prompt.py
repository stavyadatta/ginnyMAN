def get_attr_prompt(attributes):
    ...
    the output should be in JSON, the general structure of the output is 

    If the input cotains name then you will output the name as well
    ...
    output: {
        ...
        "reasoning": <if attribute is not mentioned in known attributes>"The attributes is not mentioned in the known attribute list and the statement suggests is a strong indication of likings ",
    ...
    output: {
        ...
        "reasoning": <If this attribute is already mentioned in known attributes>"The attributes is mentioned in the known attribute list and the statement suggests is a strong indication of likings ",
        "attribute": ""
        "name": ""
    }
