...
movement_prompt = f""" 
You are part of the IRIS robot's locomotion reasoning, any prompt that comes to you 
will have to reply in form of movements that will be executed by the IRIS robot
