...
yolo_world = read_python_file("/workspace/iris_server/core_api/yolo/yolo_world.py")
chatgpt = read_python_file("/workspace/iris_server/core_api/chatgpt/chatgpt.py")
grok = read_python_file("/workspace/iris_server/core_api/grok/grok.py")
