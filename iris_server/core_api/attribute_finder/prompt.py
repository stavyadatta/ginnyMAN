def get_attr_prompt(attributes):
    attribute_prompt = f""" 
    You are part of IRIS robot's attribute finder system. Your task is to identify 
...
def check_friend_name_prompt():
    return """ 
       You are part of IRIS robot's name finder, you will be given a conversation 
